...
"[project]/grAInBE/app/api/auth/login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$grAInBE$2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        email
    });
    ...
    const match = await __TURBOPACK__imported__module__$5b$project$5d2f$grAInBE$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(password, user.password);
    if (!match) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$grAInBE$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "Invalid credentials"
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__12es-xq._.js.map